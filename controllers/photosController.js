...
/**
 * Handles Flickr api call to get recent photos.
...
module.exports.getPhotos = function retreivePhotos(req, res) {
  ...
  request(flickrUrl + '?method=flickr.photos.getRecent&api_key=' + constants.apiKey +
    '&per_page=10&page=' + page +
    '&format=json&nojsoncallback=1', function(err, response, body) {
      if (err) {
